...
- [Investigación](https://conference2021.eaamo.org/cfpresearchspanish/)
- [Políticas públicas y práctica](https://conference2021.eaamo.org/cfppolicyspanish)
...
- **Teoría** incluyendo diseño de algoritmos, división equitable y redistribución de recursos, teoría de juegos, diseño de mercados y diseño de mecanismos, optimización, administración de la producción, decisión social computacional, análisis de redes sociales, y teoría de machine learning.
...
Se puede registrar [aquí](https://conference2021.eaamo.org/registration) para la conferencia. Se proveerá asistencia financiera para costos de registro, al igual que planes de datos móviles para asistir a los eventos virtuales. **Todas las aplicaciones para asistencia financiera se deberán entregar antes del 14 de Junio a las 5PM ET.** No se considerarán aplicaciones que se reciban después de tal fecha.
